...
namespace GameServer.Interfaces
{
    ...
    {   
        ...
        /// <summary>
        /// Returns the last time the Leagues were updated
        /// </summary>
        /// <returns>The date and time</returns>
        DateTime GetLastLeagueUpdate();
        ...
        /// <summary>
        /// Get all active spectatable games
        /// </summary>
        /// <returns></returns>
        List<IGame> GetAllActiveSpectatableGames();
        ...
        void LeaveGame(User userToLeave, IGame game);
    }
}
